module Validators
  ...
  class NcuValidator < Base
    def validate!(data, path: "$")
      ...
      validate_movement!(data, path: path) if given?(data, "movement")
    ...
    def validate_movement!(data, path:)
      UnitMovementValidator.validate!(data["movement"], path: child_path(path, "movement"))
    end

    def validate_dialogue!(data, path:)
      DialogueValidator.validate!(data["dialogue"], path: child_path(path, "dialogue"))
    end
