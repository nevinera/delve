...
RSpec.describe GameApi::InstancesClient do
  ...
  describe "#list" do
    ...
    it "raises AuthError on 401" do
      ...
      expect { client.list }.to raise_error(GameApi::AuthError) do |e|
    ...
    it "raises Error on 500" do
      stub_request(:get, "#{base_url}/instances")
        .to_return(status: 500, body: '{"error":"server error"}', headers: json_headers)

      expect { client.list }.to raise_error(GameApi::Error) do |e|
  ...
  describe "#show" do
    let(:instance_body) do
      {identifier: instance_id, database_id: "db-1", status: "active"}.to_json
    end
    ...
    it "returns the instance" do
      ...
      result = client.show(instance_id)
    ...
    it "raises NotFoundError on 404" do
      ...
      expect { client.show(instance_id) }.to raise_error(GameApi::NotFoundError) do |e|
  ...
  describe "#create" do
    ...
    let(:created_body) do
      {identifier: instance_id, status: "active", max_slots: 25}.to_json
    end
  ...
  describe "#destroy" do
    ...
    it "returns nil on success" do
      ...
      expect(client.destroy(instance_id)).to be_nil
    end
    ...
    it "raises NotFoundError on 404" do
      ...
      expect { client.destroy(instance_id) }.to raise_error(GameApi::NotFoundError)
    end
  end
end
