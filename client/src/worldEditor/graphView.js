...
// position and zooms out just enough that all of them are visible - same
// shape as zoneEditor/graphView.js, duplicated rather than cross-imported.
// Returns null when there's nothing to fit (no nodes) or the container
