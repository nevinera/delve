...
on the size of a zone is the number units in it that might have simultaneous
...
possibly 3, that place is huge). A zone for the Sludge Fen, for Dreadmist Peak,
...
might also take across the pass to the other side of the mountains (which leaves
